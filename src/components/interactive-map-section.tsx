        ...
        <div className="grid lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 border border-border/80 bg-card/90 rounded-sm p-6 md:p-8 shadow-sm relative overflow-hidden">
            ...
            <div className="relative w-full aspect-[16/10] bg-secondary/20 rounded-sm overflow-hidden border border-border/40 flex items-center justify-center">
              {/* STYLIZED ROMANIA GEOMETRIC OUTLINE */}
              <svg
                viewBox="0 0 100 70"
                className="w-full h-full text-brand/15 drop-shadow-sm"
              >
                {/* Romania simplified geometric silhouette */}
                <polygon
                  fill="currentColor"
                  stroke="currentColor"
                  strokeWidth="0.5"
                  className="text-brand/10"
                  points="20,28 35,18 55,15 72,20 88,32 92,48 85,62 70,68 50,65 35,68 18,58 12,42"
                />
                {/* Grid lines */}
                <line x1="0" y1="20" x2="100" y2="20" stroke="currentColor" strokeWidth="0.2" strokeDasharray="1,1" className="text-brand/20" />
                <line x1="0" y1="40" x2="100" y2="40" stroke="currentColor" strokeWidth="0.2" strokeDasharray="1,1" className="text-brand/20" />
                <line x1="0" y1="60" x2="100" y2="60" stroke="currentColor" strokeWidth="0.2" strokeDasharray="1,1" className="text-brand/20" />
                <line x1="30" y1="0" x2="30" y2="70" stroke="currentColor" strokeWidth="0.2" strokeDasharray="1,1" className="text-brand/20" />
                <line x1="60" y1="0" x2="60" y2="70" stroke="currentColor" strokeWidth="0.2" strokeDasharray="1,1" className="text-brand/20" />
                <line x1="80" y1="0" x2="80" y2="70" stroke="currentColor" strokeWidth="0.2" strokeDasharray="1,1" className="text-brand/20" />
              </svg>
